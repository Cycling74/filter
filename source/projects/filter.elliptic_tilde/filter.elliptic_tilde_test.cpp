...
#include "filter.elliptic_tilde.cpp"	// need the source of our object so that we can access it
...
SCENARIO( "object produces correct output" ) {
	...
	GIVEN( "An instance of our object" ) {
		...
		test_wrapper<elliptic> an_instance;
		elliptic& my_object = an_instance;
