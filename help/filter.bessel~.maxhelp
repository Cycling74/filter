...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 540.0, 108.903198, 49.0, 23.0 ],
									"style" : "",
									"text" : "qlim 50"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 50.0, 258.903198, 30.0, 23.0 ],
									"style" : "",
									"text" : "t b l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 465.0, 238.903198, 29.5, 23.0 ],
									"style" : "",
									"text" : "f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 465.0, 203.903198, 35.0, 23.0 ],
									"style" : "",
									"text" : "== 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 61.0, 471.903198, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 925.0, 200.0, 40.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1240.0, 95.0, 170.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1320.0, 170.0, 115.0, 64.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1180.0, 185.0, 134.0, 25.0 ],
					"style" : "",
					"text" : "filter.bessel highpass"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 660.0, 465.0, 251.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 205.0, 79.0, 25.0 ],
					"style" : "",
					"text" : "filter.bessel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 90.0, 180.0, 87.0, 25.0 ],
					"style" : "",
					"text" : "filter.bessel~"
				}
