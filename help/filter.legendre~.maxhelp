...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.0, 735.0, 465.0, 136.0 ],
					"presentation_rect" : [ 582.0, 737.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "http://www.filter-solutions.com/legendre.html\n\nThe Legendre filter is a monotonic all pole filter in that the pass band slope is always zero or downward, never upward, and it is optimized for the greatest slope at the pass band edge.\n\nLegendre filters are useful in applications which require a steep cutoff at the pass band edge without pass band ripples, or in cases where a Chebyshev I filter produces too much group delay at the pass band edge."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1055.0, 205.0, 149.0, 25.0 ],
					"style" : "",
					"text" : "filter.legendre highpass"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 735.0, 465.0, 136.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 205.0, 93.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 90.0, 180.0, 101.0, 25.0 ],
					"style" : "",
					"text" : "filter.legendre~"
				}
